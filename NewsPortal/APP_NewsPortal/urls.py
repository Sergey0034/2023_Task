...
from .views import NewList, NewDetail, NewListSearch, NewCreate, NewUpdate, NewDelete, ArticleList, ArticleDetail, ArticleListSearch, ArticleCreate, ArticleUpdate, ArticleDelete
